...
test.describe('Weather App', () => {
  ...
  test('should trigger IP fallback and show weather + approximate location badge when geolocation is denied', async ({ browser }) => {
    ...
    await page.route('https://api.open-meteo.com/**', (route) =>
      route.fulfill({
        ...
        contentType: 'application/json',
        body: JSON.stringify({
          latitude: 35.6762, longitude: 139.6503, generationtime_ms: 1, utc_offset_seconds: 32400,
          timezone: 'Asia/Tokyo', timezone_abbreviation: 'JST', elevation: 40,
          current_units: {}, daily_units: {},
          current: {
            temperature_2m: 18, relative_humidity_2m: 65, apparent_temperature: 17,
            is_day: 1, precipitation: 0, rain: 0, showers: 0, snowfall: 0,
            weather_code: 0, cloud_cover: 10, pressure_msl: 1013, surface_pressure: 1009,
            wind_speed_10m: 5, wind_direction_10m: 180, wind_gusts_10m: 10,
          },
          daily: {
            time: ['2026-02-28'], weather_code: [0],
            temperature_2m_max: [20], temperature_2m_min: [14],
            sunrise: ['2026-02-28T06:30'], sunset: ['2026-02-28T18:00'],
          },
        }),
      }),
    );
